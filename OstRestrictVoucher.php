 ...
 *
 * 1.0.1
 * - pre-version - added category whitelist
 *
...
namespace OstRestrictVoucher;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstRestrictVoucher extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_restrict_voucher.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_restrict_voucher.view_dir', $this->getPath() . '/Resources/views/');
